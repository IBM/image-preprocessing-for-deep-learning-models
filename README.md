...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/architecture.png)
...
5. User will write the predicted output to cloud object storage in csv format which can be downloaded for further analysis.
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/new_project.png)

Define the project by giving a Name and hit 'Create'.

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/define_project.png)
...
* Enter this Notebook URL: https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/notebooks/Image-classification_baseline_model.ipynb
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/create_notebook.png)

## 4. Add the data

[Clone this repo](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio)
Navigate to [images data](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/tree/master/data/images) and save the zip file on the disk. The sample data has been extracted and renamed from the original dataset.
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/add_file.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/insert.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/predictions.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/download_file.png)
...
* Enter this Notebook URL: https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/notebooks/Image_classification_WML_model_Testing_Deployment.ipynb
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/deploy_the_model.png)

### Generate scoring URL

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/deployment_url.png)
...
Navigate to [scripts-for-experiments](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/tree/master/scripts-for-experiments) and download the zip file onto the system. `This zip file is critical for creating and running experiments successfully. If you want to modify the model parameters or create a new model, then it has to be done in image_classify.py file and then zip it to be uploaded for experiments.`
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/new-experiment.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/define-experiment.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/add-trng-defn.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/create-trng-defn.png)

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/select-code-frmwrk.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/select-paramtr-opt.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/lr.png)

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/bs.png)

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/epochs.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/trng-status.png)

`Compare` different training runs

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/compare-runs.png)

Check the `accuracy` of training runs

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/check-accuracy.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/save-model.png)

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/save-deplyd-mdl.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/view-model.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/create-dplymt.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/deploy-success.png)

Click on `Deployments` to find the instance we have deployed and select the instance by clicking on it. 

![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/view-saved-model.png)
...
![](https://github.com/RK-Sharath/multi-class-image-classification-using-watson-studio/blob/master/doc/source/images/predict.png)
